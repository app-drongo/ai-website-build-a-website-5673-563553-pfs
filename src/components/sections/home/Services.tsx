...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      longDescription:
        'Our seasonal maintenance program ensures your landscape looks its best throughout the year. From spring cleanup to winter preparation, we handle all the seasonal tasks to maintain your outdoor paradise.',
      icon: Calendar,
      benefits: [
        'Spring cleanup and preparation',
        'Summer maintenance programs',
        'Fall leaf removal and winterization',
        'Snow removal and winter protection',
      ],
      pricing: 'Starting at $99/month',
      timeline: 'Scheduled seasonal visits',
      badge: 'Essential',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Professional landscaping services using 100% organic methods, backed by 15+ years of
            experience and certified arborists
          </p>
        </div>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-muted/50 text-center">
          ...
          <h3 className="text-2xl font-semibold mb-3">Need a Custom Landscape Solution?</h3>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Every property is unique. Let our certified experts create a personalized maintenance
            plan that fits your landscape and budget perfectly.
          </p>
