...
import { ArrowRight, Leaf, TreePine, Scissors, Calendar } from 'lucide-react';
...
export default function Cta() {
  ...
  const stats = [
    ...
    { value: '15+', label: 'Years Experience', icon: Leaf },
    { value: '100%', label: 'Eco-Friendly Methods', icon: Leaf },
    { value: 'Year-Round', label: 'Seasonal Care', icon: Calendar },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-8">
                ...
                Spring Season Special - 20% Off First Month
              </div>
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of satisfied homeowners and businesses who trust GreenThumb Landscapes
                for professional, eco-conscious landscaping services that nurture both beauty and
                sustainability.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Certified organic practices • Licensed & insured • Local family business
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">100% Organic Methods</h3>
              <p className="text-sm text-muted-foreground">
                Chemical-free treatments safe for families and pets
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Expert Tree Care</h3>
              <p className="text-sm text-muted-foreground">
                Certified arborists for professional pruning and health
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Year-Round Care</h3>
              <p className="text-sm text-muted-foreground">
                Seasonal maintenance plans starting at $99/month
              </p>
            </div>
          </div>
        </div>
